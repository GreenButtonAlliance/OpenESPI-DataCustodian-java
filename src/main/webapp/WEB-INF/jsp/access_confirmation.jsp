...
<div class="container">
    ...
    <authz:authorize ifAllGranted="ROLE_USER">
        ...
        <form id="confirmationForm" name="confirmationForm" action="<%=request.getContextPath()%>/oauth/2_0/authorize" method="post">
        ...
        <form id="denialForm" name="denialForm" action="<%=request.getContextPath()%>/oauth/2_0/authorize" method="post">
