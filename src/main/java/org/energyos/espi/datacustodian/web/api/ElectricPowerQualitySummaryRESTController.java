...
public class ElectricPowerQualitySummaryRESTController {
   ...
   private ResourceService resourceService;
    ...
    // 
    //
    @RequestMapping(value = Routes.ELECTRIC_POWER_QUALITY_SUMMARY_MEMBER, method = RequestMethod.GET)
    public void show(HttpServletResponse response, 
    		@PathVariable long retailCustomerId,
    		@PathVariable long usagePointId,
    		@PathVariable long electricPowerQualitySummaryId,
    ...
    // 
    //
    @RequestMapping(value = Routes.ELECTRIC_POWER_QUALITY_SUMMARY_COLLECTION, method = RequestMethod.POST)
    public void create(HttpServletResponse response, 
    		@PathVariable long retailCustomerId,
    		@PathVariable long usagePointId,
    		@RequestParam Map<String, String> params,
        ...
        try {
        	if (null != resourceService.findIdByXPath(retailCustomerId, usagePointId, UsagePoint.class)) {
        		...
        		ElectricPowerQualitySummary electricPowerQualitySummary = electricPowerQualitySummaryService.importResource(stream);
    ...
    @RequestMapping(value = Routes.ELECTRIC_POWER_QUALITY_SUMMARY_MEMBER, method = RequestMethod.PUT)
    public void update(HttpServletResponse response, 
    		@PathVariable long retailCustomerId,
    		@PathVariable long usagePointId,
    		@PathVariable long electricPowerQualitySummaryId,
