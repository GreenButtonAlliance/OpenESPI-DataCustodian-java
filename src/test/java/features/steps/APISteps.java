...
public class APISteps {
	...
	public void I_GET_espi_1_1_resource_RetailCustomer_RetailCustomerID_UsagePoint()
			throws Throwable {
	...
	public void I_should_receive_the_Usage_Point() throws SAXException,
	...
	public void the_Usage_Point_should_be_deleted() throws Throwable {
		...
		assertThat(
				getXPathValue("/:feed/:entry/:link[@rel='self']/@href", xml),
				is(not("RetailCustomer/" + CucumberSession.getUserHashedId()
						+ "/UsagePoint/"
						+ CucumberSession.getUsagePointHashedId())));
	}
