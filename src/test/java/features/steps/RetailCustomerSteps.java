...
import static org.greenbuttonalliance.espi.common.test.BaseStepUtils.newFirstName;
import static org.greenbuttonalliance.espi.common.test.BaseStepUtils.newLastName;
import static org.greenbuttonalliance.espi.common.test.BaseStepUtils.newUsername;
import static org.greenbuttonalliance.espi.common.test.BaseStepUtils.selectRadioByLabel;
...
public class RetailCustomerSteps {
	...
	public void I_should_see_Grace_Hopper_in_the_customer_list()
			throws Throwable {
	...
	public void I_should_be_able_to_download_Usage_Points_in_XML_format()
			throws Throwable {
		WebElement downloadLink = driver.findElement(By
				.partialLinkText("Download XML"));
		downloadLink.click();
	...
	public void the_logged_in_retail_customer_can_see_their_usage_data()
			throws Throwable {
	...
	public void the_XML_includes_Service_categories() throws Throwable {
		assertXpathValue(
				"0",
				"/:feed/:entry[1]/:content/espi:UsagePoint/espi:ServiceCategory/espi:kind",
				xmlResult);
	}
	...
	public void the_XML_includes_Meter_Readings() throws Throwable {
		assertXpathValue("Fifteen Minute Electricity Consumption",
				"/:feed/:entry/:content/espi:MeterReading/../../:title",
				xmlResult);
	}
	...
	public void the_XML_includes_Reading_Types() throws Throwable {
		assertXpathValue("Type of Meter Reading Data",
				"/:feed/:entry/:content/espi:ReadingType/../../:title",
				xmlResult);
	}

	@Ignore
	@Then("^the XML includes Electric Power Usage Summary$")
	public void the_XML_includes_Electric_Power_Usage_Summary()
			throws Throwable {
		assertXpathValue(
				"Usage Summary",
				"/:feed/:entry/:content/espi:ElectricPowerUsageSummary/../../:title",
				xmlResult);
		assertXpathValue(
				"1119600",
				"//:content/espi:ElectricPowerUsageSummary/espi:billingPeriod/espi:duration",
				xmlResult);
	}
	...
	public void the_XML_includes_Interval_Blocks() throws Throwable {
		assertXpathValue(
				"86400",
				"/:feed/:entry[4]/:content/espi:IntervalBlock/espi:interval/espi:duration",
				xmlResult);
	}
	...
	public void the_XML_includes_Interval_Readings() throws Throwable {
		assertXpathValue(
				"974",
				"/:feed/:entry[4]/:content/espi:IntervalBlock/espi:IntervalReading[1]/espi:cost",
				xmlResult);
		assertXpathValue(
				"900",
				"/:feed/:entry[4]/:content/espi:IntervalBlock/espi:IntervalReading[1]/espi:timePeriod/espi:duration",
				xmlResult);
		assertXpathValue(
				"1330578900",
				"/:feed/:entry[4]/:content/espi:IntervalBlock/espi:IntervalReading[2]/espi:timePeriod/espi:start",
				xmlResult);
		assertXpathValue(
				"965",
				"/:feed/:entry[4]/:content/espi:IntervalBlock/espi:IntervalReading[2]/espi:cost",
				xmlResult);
	}
	...
	public void a_Retail_Customer() throws Throwable {
		...
		StepUtils.registerUser(CucumberSession.getUsername(), newFirstName(),
				newLastName(), StepUtils.PASSWORD);
	}
	...
	public void I_should_be_taken_to_the_Third_Party_login_page()
			throws Throwable {
		assertNotNull("Login field missing",
				driver.findElement(By.name("j_username")));
		assertNotNull("Password field missing",
	...
	public void the_XML_includes_Reading_Qualities() throws Throwable {
		assertXpathValue(
				"8",
				"/:feed/:entry[4]/:content/espi:IntervalBlock[1]/espi:IntervalReading[1]/espi:ReadingQuality[1]",
				xmlResult);
	}

	@Ignore
	@Then("^the XML includes Electric Power Quality Summary$")
	public void the_XML_includes_Electric_Power_Quality_Summary()
			throws Throwable {
		assertXpathValue(
				"Quality Summary",
				"/:feed/:entry/:content/espi:ElectricPowerQualitySummary/../../:title",
				xmlResult);
		assertXpathValue(
				"2119600",
				"//:content/espi:ElectricPowerQualitySummary/espi:summaryInterval/espi:duration",
				xmlResult);
	}
	...
	public void the_XML_includes_Local_Time_Parameters() throws Throwable {
		assertXpathValue("DST For North America",
				"/:feed/:entry/:content/espi:LocalTimeParameters/../../:title",
				xmlResult);
		assertXpathValue(
				"360E2000",
				"/:feed/:entry/:content/espi:LocalTimeParameters/espi:dstStartRule",
				xmlResult);
	}
