...
@Transactional
public class FeedBuilderReadingTypeTests {
    ...
    public void returnsEntryWithTitle() throws FeedException {
        assertEquals("Energy Delivered (kWh)", entry.getTitle());
    }
    ...
    @Test
    public void returnsEntryWithContentWithReadingType() throws FeedException, SAXException, IOException, XpathException {
        assertXpathExists("ReadingType", contents.get(0).getValue());
    }
